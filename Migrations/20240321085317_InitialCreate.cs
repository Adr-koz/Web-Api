        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Publishers_Genres_GenreId",
                        column: x => x.GenreId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PublisherTitle", x => new { x.PublishersId, x.TitlesId });
                    table.ForeignKey(
                        name: "FK_PublisherTitle_Publishers_PublishersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Titles_Genres_GenreId",
                        column: x => x.GenreId,
                        principalTable: "Genres",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Titles_Reviews_ReviewId",
                        column: x => x.ReviewId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TitlePublishers", x => new { x.TitleId, x.PublisherId });
                    table.ForeignKey(
                        name: "FK_TitlePublishers_Publishers_PublisherId",
                        column: x => x.PublisherId,
                        principalTable: "Publishers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TitlePublishers_Titles_TitleId",
                        column: x => x.TitleId,
                        principalTable: "Titles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Publishers_GenreId",
                table: "Publishers",
                column: "GenreId");

            migrationBuilder.CreateIndex(
                name: "IX_PublisherTitle_TitlesId",
                table: "PublisherTitle",
                column: "TitlesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TitlePublishers_PublisherId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Titles_GenreId",
                table: "Titles",
                column: "GenreId");

            migrationBuilder.CreateIndex(
                name: "IX_Titles_ReviewId",
                table: "Titles",
                column: "ReviewId");

            migrationBuilder.AddForeignKey(
                name: "FK_PublisherTitle_Titles_TitlesId",
                table: "PublisherTitle",
                column: "TitlesId",
                principalTable: "Titles",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Reviews_Titles_BookTitleId",
                table: "Reviews",
                column: "BookTitleId",
                principalTable: "Titles",
                principalColumn: "Id",
